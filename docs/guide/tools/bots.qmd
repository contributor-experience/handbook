...
respond to first time PRs & issues with a welcome message that provides links
to a project's resources like contributing guidelines, code of conduct, community events calendar, etc.

[PR-Triage Bot](https://github.com/apps/pr-triage) helps automatically 
add labels to new PRs or issues.

[All-Contributors Bot](https://github.com/apps/allcontributors) helps 
capture different contributions and add them to a specified file in the repo.
This bot is very useful for managing contributions such as PR reviews, ideas, 
